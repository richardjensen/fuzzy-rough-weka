...
public class FeatureVoteHarmonySearch extends ASSearch
    ...
    public double discardThreshold = 0.5;
    public double randomThreshold = 0.8;
    public int ensembleSize = 10;

    public int iteration = 250;
    ...
    public void setOptions(String[] options)
        ...
        if (optionString.length() != 0) {
            setEnsembleSize(Integer.valueOf(optionString));
        }
        ...
        if (optionString.length() != 0) {
            setDiscardThreshold(Double.valueOf(optionString));
        }
        
        optionString = Utils.getOption('R', options);
        if (optionString.length() != 0) {
            setRandomThreshold(Double.valueOf(optionString));
        }
    ...
    public String[] getOptions() {
        ...
        options[current++] = "-S";
        options[current++] = "" + getEnsembleSize();
        
        options[current++] = "-Z";
        options[current++] = "" + getM_seed();
        
        options[current++] = "-D";
        options[current++] = "" + getDiscardThreshold();

        options[current++] = "-R";
        options[current++] = "" + getRandomThreshold();
...
/*            temp = generateRandomSubset();
    ...
    public class Expert {
        ...
        public Expert(int size) {
            ...
            cardinality = 0;
            //System.out.println("New Expert Size = " + size);
        }
